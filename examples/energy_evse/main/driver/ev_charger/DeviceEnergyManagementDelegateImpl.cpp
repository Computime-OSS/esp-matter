...
{
    PRINTF_DEBUG("DeviceEnergyManagementDelegate::HandlePowerAdjustTimerExpiry");
...
Status DeviceEnergyManagementDelegate::StartTimeAdjustRequest(const uint32_t requestedStartTimeUtc, AdjustmentCauseEnum cause)
{
    ...
    case AdjustmentCauseEnum::kGridOptimization:
        ...
        break;
    default:
        PRINTF_DEBUG("Bad cause %d", to_underlying(cause));
        return Status::Failure;
        break;
    }
...
Status DeviceEnergyManagementDelegate::ModifyForecastRequest(
    const uint32_t forecastID, const DataModel::DecodableList<DeviceEnergyManagement::Structs::SlotAdjustmentStruct::DecodableType> & slotAdjustments,
    AdjustmentCauseEnum cause)
{
    Status status = Status::Success;
...
Status DeviceEnergyManagementDelegate::RequestConstraintBasedForecast(
    const DataModel::DecodableList<DeviceEnergyManagement::Structs::ConstraintsStruct::DecodableType> & constraints, AdjustmentCauseEnum cause)
{
    Status status = Status::Success;
...
const DataModel::Nullable<DeviceEnergyManagement::Structs::PowerAdjustCapabilityStruct::Type> &
DeviceEnergyManagementDelegate::GetPowerAdjustmentCapability()
{
    return mPowerAdjustCapabilityStruct;
}

const DataModel::Nullable<DeviceEnergyManagement::Structs::ForecastStruct::Type> & DeviceEnergyManagementDelegate::GetForecast()
{
    PRINTF_DEBUG("DeviceEnergyManagementDelegate::GetForecast");
...
{
    PRINTF_DEBUG("mOptOutState %d", to_underlying(mOptOutState));
    return mOptOutState;
}
...
CHIP_ERROR DeviceEnergyManagementDelegate::SetESAType(ESATypeEnum newValue)
{
    ...
    {
        PRINTF_DEBUG("mEsaType updated to %d", static_cast<int>(mEsaType));
        MatterManager::ReportAttributeChangeToMatter(mEndpointId, DeviceEnergyManagement::Id, ESAType::Id);
    }
...
CHIP_ERROR DeviceEnergyManagementDelegate::SetESACanGenerate(bool newValue)
{
    ...
    if (oldValue != newValue)
    {
        PRINTF_DEBUG("mEsaCanGenerate updated to %d", static_cast<int>(mEsaCanGenerate));
        MatterManager::ReportAttributeChangeToMatter(mEndpointId, DeviceEnergyManagement::Id, ESACanGenerate::Id);
    }
...
CHIP_ERROR DeviceEnergyManagementDelegate::SetESAState(ESAStateEnum newValue)
{
    ...
    if (oldValue != newValue)
    {
        PRINTF_DEBUG("mEsaState updated to %d", static_cast<int>(mEsaState));
        MatterManager::ReportAttributeChangeToMatter(mEndpointId, DeviceEnergyManagement::Id, ESAState::Id);
    }
...
CHIP_ERROR DeviceEnergyManagementDelegate::SetAbsMinPower(int64_t newValueMw)
{
    ...
    {
        PRINTF_DEBUG("mAbsMinPower updated to " ChipLogFormatX64, ChipLogValueX64(mAbsMinPowerMw));
        MatterManager::ReportAttributeChangeToMatter(mEndpointId, DeviceEnergyManagement::Id, AbsMinPower::Id);
    }
...
CHIP_ERROR DeviceEnergyManagementDelegate::SetAbsMaxPower(int64_t newValueMw)
{
    ...
    if (oldValueMw != newValueMw)
    {
        PRINTF_DEBUG("mAbsMaxPower updated to " ChipLogFormatX64, ChipLogValueX64(mAbsMaxPowerMw));
        MatterManager::ReportAttributeChangeToMatter(mEndpointId, DeviceEnergyManagement::Id, AbsMaxPower::Id);
    }
...
CHIP_ERROR DeviceEnergyManagementDelegate::SetForecast(const DataModel::Nullable<DeviceEnergyManagement::Structs::ForecastStruct::Type> & forecast)
{
    assertChipStackLockedByCurrentThread();
